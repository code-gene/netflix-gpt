...
const GptSearchBar = () => {
  ...
  const handleGptSearchClick = async () => {
    ...
    const gptQuery =
      "Act as a Movie Reccomendation and suggest some movies for the query" +
      searchOpenAIText +
      ". Only give me names 5 movies, comma seperated like the example result given ahead. Example Result: Gadar, Don, Sholay, Run, Golmaal";
